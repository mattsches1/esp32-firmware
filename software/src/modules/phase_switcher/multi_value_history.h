...
public:
    ...
    void tick(uint32_t now, bool update_history, MULTI_VALUE_HISTORY_VALUE_TYPE *live_sample[MULTI_VALUE_HISTORY_NUMBER_OF_VALUES], MULTI_VALUE_HISTORY_VALUE_TYPE *history_sample[MULTI_VALUE_HISTORY_NUMBER_OF_VALUES]);
    ...
    float sample_sum[MULTI_VALUE_HISTORY_NUMBER_OF_VALUES] = {0};
