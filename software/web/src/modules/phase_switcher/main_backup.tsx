...
export class PhaseSwitcher extends ConfigComponent<'phase_switcher/config', {}, PhaseSwitcherConfig & PhaseSwitcherState & PhaseSwitcherLowLevelState> {
    constructor() {
        ...
        util.addApiEventListener('phase_switcher/low_level_state', () => {
            this.setState({...API.get('phase_switcher/low_level_state')});
        });
                        ...
                        <div class="row mx-n1">
                            <div class="mb-1 col-6 px-1">
                                <InputNumber required
                                            ...
                                            max={3600}
                                            unit="s"
                                            value={state.minimum_duration}
                                            onValue={this.set("minimum_duration")}/>
                            </div>
                            <div class="mb-1 col-6 px-1">
                                <InputText value={util.format_timespan(state.sequencer_state == 20 ? state.time_since_state_change : 0)}/>
                            </div>
                        </div>
                    </FormRow>
                        ...
                        <div class="row mx-n1">
                            <div class="mb-1 col-6 px-1">
                                <InputNumber required
                                            ...
                                            max={3600}
                                            unit="s"
                                            value={state.pause_time}
                                            onValue={this.set("pause_time")}/>
                            </div>
                            <div class="mb-1 col-6 px-1">
                                <InputText value={util.format_timespan(state.sequencer_state == 40 ? state.time_since_state_change : 0)}/>
                            </div>
                        </div>
                    </FormRow>
